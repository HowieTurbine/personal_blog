<%@ page import="com.hiber.session.HibernateSession" %>
<%@ page import="com.hiber.model.ArticlesEntity" %>
<!DOCTYPE html>
	...
	<section id="container">
		<div class="wrap-container">
			...
			<%
				...
				ArticlesEntity articleEntity =hibernateSession.select();
				System.out.println("3");
				String title=articleEntity.getTitle();
				String author=articleEntity.getAuthor();
				String time=articleEntity.getTime().toString();
				String text=articleEntity.getContent();
			%>
			<article class="post zerogrid">
				<div class="row wrap-post"><!--Start Box-->
					<div class="entry-header">
						<span class="time"><%out.print(time);%></span>
						<h2 class="entry-title"><a href="#"><%out.print(title);%></a></h2>
						<br>
						<h4 class="content-box">Author:<%out.print(author);%></h4>
						<br>
						<p class="content-box"><%out.print(text);%></p>
					</div>
				</div>
			</article>
